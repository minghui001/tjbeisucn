window.onload = function () {
    var ul_Nav = document.getElementsByClassName("downList"); var index_01 = document.getElementById("index_01"); var li_Nav = ul_Nav.children; var aGroup = []; var sid = getQueryString("sid"); var windowHref = window.location.href; getObjA(); findParentById(sid); index_01.className = "";
}
